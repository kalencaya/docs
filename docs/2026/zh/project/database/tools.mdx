...
* [outerbase-studio](https://github.com/outerbase/studio)。[playground](https://libsqlstudio.com/playground/client)
* [hue](https://github.com/cloudera/hue)
* [websql](https://gitee.com/boy_0214/websql)
* [sql-studio](https://github.com/frectonz/sql-studio)。在线体验地址：[sql-studio](https://sql-studio.frectonz.et/)
