...
START((STAET));
START -----> PENDING;
RUNNING(RUNNING) -- COMMAND_SUSPEND --->SUSPEND(SUSPEND);
RUNNING(RUNNING) -- PROCESS_FAILURE --->FAILURE(FAILURE);
RUNNING(RUNNING) -- PROCESS_STEP_CHANGE --->RUNNING(RUNNING);
RUNNING(RUNNING) -- COMMAND_SHUTDOWN --->SHUTDOWN(SHUTDOWN);
RUNNING(RUNNING) -- PROCESS_SUCCESS --->SUCCESS(SUCCESS);
PENDING(PENDING) -- COMMAND_SUSPEND --->SUSPEND(SUSPEND);
PENDING(PENDING) -- COMMAND_DEPLOY --->RUNNING(RUNNING);
PENDING(PENDING) -- COMMAND_SHUTDOWN --->SHUTDOWN(SHUTDOWN);
PENDING(PENDING) -- COMMAND_INIT --->PENDING(PENDING);
PENDING(PENDING) -- PROCESS_SUCCESS --->SUCCESS(SUCCESS);
SUSPEND(SUSPEND) -- COMMAND_SHUTDOWN --->SHUTDOWN(SHUTDOWN);
SUSPEND(SUSPEND) -- COMMAND_RESUME --->RUNNING(RUNNING);
END((END));
FAILURE -----> END;
SHUTDOWN -----> END;
SUCCESS -----> END;
...
RUNNING(RUNNING) -- COMMAND_SUSPEND --->SUSPEND(SUSPEND);
RUNNING(RUNNING) -- PROCESS_FAILURE --->FAILURE(FAILURE);
RUNNING(RUNNING) -- PROCESS_TASK_CHANGE --->RUNNING(RUNNING);
PENDING(PENDING) -- COMMAND_SHUTDOWN --->SHUTDOWN(SHUTDOWN);
PENDING(PENDING) -- PROCESS_SKIP_CAUSE_BY_SHUTDOWNED --->SKIP(SKIP);
PENDING(PENDING) -- COMMAND_DEPLOY --->RUNNING(RUNNING);
PENDING(PENDING) -- COMMAND_SUSPEND --->SUSPEND(SUSPEND);
SUSPEND(SUSPEND) -- COMMAND_SHUTDOWN --->SHUTDOWN(SHUTDOWN);
SUSPEND(SUSPEND) -- COMMAND_RESUME --->RUNNING(RUNNING);
...
PENDING(PENDING) -- COMMAND_SHUTDOWN --->SHUTDOWN(SHUTDOWN);
RUNNING(RUNNING) -- PROCESS_FAILURE --->FAILURE(FAILURE);
RUNNING(RUNNING) -- COMMAND_RUN --->RUNNING(RUNNING);
RUNNING(RUNNING) -- COMMAND_SHUTDOWN --->SHUTDOWN(SHUTDOWN);
RUNNING(RUNNING) -- PROCESS_SUCCESS --->SUCCESS(SUCCESS);
END((END));
FAILURE -----> END;
